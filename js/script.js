...
const themes = {
    ...
    ocean: {
        ...
        "--player-tab-active-back-color": "#caf0f8",
    ...
    forest: {
        ...
        "--player-tab-active-back-color": "#b7e4c7",
    ...
    lavender: {
        ...
        "--player-tab-active-back-color": "#e0aaff",
    ...
    neon: {
        ...
        "--player-tab-active-back-color": "#ffcc00",
    ...
    pastel: {
        ...
        "--white": "#edf2f4",
        "--menu-color": "#946174",
        "--home-c1-color": "#ffc8dd",
        "--home-c2-color": "#bde0fe",
        "--home-c3-color": "#a2d2ff",
        "--home-c4-color": "#cdb4db",
        "--player-back-color": "#fb6f92",
        "--settings-back-color": "#ff9a8b",
        "--about-back-color": "#ff758f",
        "--menu-text-color": "#000000",
        "--player-text-color": "#353a43",
        "--player-tab-back-color": "#ffc8dd",
        "--player-tab-text-color": "#8d99ae",
        "--player-tab-active-back-color": "#fb6f92",
